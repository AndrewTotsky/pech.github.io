...
*/
    var m = this || self,
        n = "closure_uid_" + ((Math.random() * 1e9) >>> 0),
        da = 0,
        t = function (a) {
            return a;
        }; /*
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
    ...
    var oa = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        wa = function (a, b, c, d, e) {
            var f = a.split(";"),
                ...
                l = na[k],
                p = null;
            l ? (p = l(f, b, c, d)) : V("no hint processor for: " + k);
            p || V("failed to generate load url");
            b = p;
            c = b.match(ta);
            ((d = b.match(ua)) &&
                d.length === 1 &&
        ...
        xa = function (a) {
            ...
            for (var d = 0, e = b.length; d < e; ++d) {
                ...
                f.length == 2 && k && l && (a[k] = a[k] || l);
            }
            b = "/" + c.join("/");
            oa.test(b) || V("invalid_prefix");
            c = 0;
            for (d = pa.length; c < d; ++c)
                pa[c].test(b) && V("invalid_prefix");
            c = W(a, "k", !0);
            d = W(a, "am");
            e = W(a, "rs");
            a = W(a, "t");
            return { pathPrefix: b, version: c, g: d, i: e, j: a };
        },
        ya = function (a) {
    ...
    var X = decodeURI("%73cript"),
        ...
        Ca = function () {
            var a = M.nonce;
            return a !== void 0
                ? a && a === String(a) && a.match(Aa)
                    ? a
                    : (M.nonce = null)
                : F.querySelector
                ? (a = F.querySelector("script[nonce]"))
        ...
        Ia = function (a, b) {
            ...
            if (!(a = c.h) && ((a = N()), !a)) throw Error("Bad hint: !hint");
            Ha(b || [], c, a);
        },
        Ha = function (a, b, c) {
            a = ia(a) || [];
            ...
            if (r.length) {
                ...
                if (r.length) {
                    ...
                    l.push.apply(l, r);
                    T("ml0", r, K);
                    b.sync || E.___gapisync ? Ea(a) : Da(a);
                } else u[v](fa);
            } else la(r) && d && d();
        },
        Ja;
    ...
    window.gapi.load("", {
        ...
        _c: {
            ...
            jsl: {
                ...
                h: "m;/_/scs/abc-static/_/js/k=gapi.lb.en.fwXSHnIYz-4.O/d=1/rs=AHpOoo_SvulQ5pP6FvvJyrQeIOJ4MStGTQ/m=__features__",
